    ...
    if (netsuccess) {
        ...
        while (initmultiplayerscycle()) {
            ...
            if (quitevent) {
                ...
                uninittimer();
                uninitinput();
printf ("----------------------------------- uniti engone  7 \n");
buildprintf ("-------------------------------uniti engine  7 \n");
                uninitengine();
                uninitsb();
                uninitgroupfile();
                return 0;
	...
	if (option[4] > 0)
	{
		...
		while (numplayers < waitplayers)
		{
			...
			if (keystatus[1])
			{
				...
				uninittimer();
				uninitinput();
printf ("----------------------------------- uniti engone  8 \n");
buildprintf ("-------------------------------uniti engine  8 \n");
				uninitengine();
				uninitsb();
				uninitgroupfile();
				exit(0);
...
//      if (keystatus[0x2b]) { keystatus[0x2b] = 0; preparesndbuf(); }
	...
	uninittimer();
	uninitinput();
printf ("----------------------------------- uniti engone  9 \n");
buildprintf ("-------------------------------uniti engine  9 \n");
	uninitengine();
	uninitsb();
	uninitgroupfile();
...
void prepareboard(char *daboardfilename)
{
	...
	if (loadboard(daboardfilename,0,&posx[0],&posy[0],&posz[0],&ang[0],&cursectnum[0]) == -1)
	{
		...
		uninittimer();
		uninitinput();
printf ("----------------------------------- uniti engone  10 \n");
buildprintf ("-------------------------------uniti engine  10 \n");
		uninitengine();
		uninitsb();
		uninitgroupfile();
...
void playback(void)
{
	...
	uninittimer();
	uninitinput();
printf ("----------------------------------- uniti engone  11 \n");
puildprintf ("-------------------------------uniti engine  11 \n");
	uninitengine();
	uninitsb();
	uninitgroupfile();
	exit(0);
...
void setup3dscreen(void)
{
	...
	if (i < 0)
	{
		...
		uninittimer();
		uninitinput();
printf ("----------------------------------- uniti engone  12 \n");
buildprintf ("-------------------------------uniti engine  12 \n");
		uninitengine();
		uninitsb();
		uninitgroupfile();
		exit(0);

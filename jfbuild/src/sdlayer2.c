...
#include <SDL_syswm.h>
//markus SDL2 probably closes, clears it when closing ????
struct Library * IntuitionBase = NULL;
struct IntuitionIFace *IIntuition = NULL;
*/
#define AMIGA_VERSION "NBlood-Amiga Port by BSzili compiling for AOS4 smarkusg (11.09.2024)"
...
//#ifndef __APPLE__ ||  ifndef __AMIGAOS4__
...
*/
	...
	if (sdl_window) {
       ...
       if (name && sdl_window) {
           static char buf [512];
           strcpy(buf, "NBlood-Amiga: ");
           strcat(buf,name);
           Bstrncpy(wintitle, buf, sizeof(wintitle)-1);
           wintitle[ sizeof(wintitle)-1 ] = 0;
...
//
/* markus int inittimer(int tickspersecond)
{
...
//		sdl_window = SDL_CreateWindow(wintitle, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, x, y, flags);
		sdl_window = SDL_CreateWindow("NBlood-Amiga", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, x, y, flags);
		if (!sdl_window) {
...
#ifdef __AMIGAOS4__ //markus mouse hide the mouse pointer and lock mouse in window

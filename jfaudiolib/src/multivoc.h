...
int   MV_PlayLoopedVorbis( char *ptr, unsigned int length, int loopstart, int loopend,
                        ...
                        unsigned int callbackval );
#ifdef HAVE_MPEG
int   MV_PlayMPEG( char *ptr, unsigned int length, int pitchoffset, int vol, int left, int right,
                  int priority, unsigned int callbackval );
int   MV_PlayLoopedMPEG( char *ptr, unsigned int length, int loopstart, int loopend,
                        int pitchoffset, int vol, int left, int right, int priority,
                        unsigned int callbackval );
#endif

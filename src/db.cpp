...
#ifndef EDUKE32
extern "C" int qloadboard(char *filename, char flags, int *daposx, int *daposy, int *daposz, short *daang, short *dacursectnum)
{
    return dbLoadMap(filename, daposx, daposy, daposz, daang, dacursectnum, NULL);
}
#else

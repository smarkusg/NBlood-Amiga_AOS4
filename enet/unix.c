...
#define inet_ntoa(a) Inet_NtoA((a).s_addr)
#define select(nfds, read_fds, write_fds, except_fds, _timeout) WaitSelect((nfds), (read_fds), (write_fds), (except_fds), (_timeout), NULL)
#define HAS_SOCKLEN_T 1
#else

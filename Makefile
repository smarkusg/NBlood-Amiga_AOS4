...
amigaos4 = -gstabs -mno-altivec -mstrict-align -mcrt=newlib -fno-plt -pipe -ffast-math

CC?=gcc
CXX?=g++
NASM?=nasm
RC?=windres
OURCFLAGS=$(debug) $(amigaos4) -W -Wall -Wno-write-strings -Wno-char-subscripts -Wno-unused \
...
OURCXXFLAGS=-std=gnu++14 -D_GNU_SOURCE -fno-exceptions -fno-rtti -Wno-narrowing -I$(INC)

LIBS=-lm -athread=native -Wl,-N -Wl,-T /work/amigaos.x
GAMELIBS=
NASMFLAGS=-s #-g
EXESUFFIX=
